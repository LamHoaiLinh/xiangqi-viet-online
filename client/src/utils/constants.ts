...
export const pieceSetOptions = [
  { id: 'classic', name: 'Quân mặc định', hint: 'Bộ quân gốc đang dùng' },
  { id: 'gold_large', name: 'Quân vàng lớn', hint: 'Bộ quân vàng viền sáng' },
  { id: 'stone', name: 'Quân đá núi', hint: 'Chất liệu đá xám tự nhiên' },
  { id: 'ivory', name: 'Quân ngà vân gỗ', hint: 'Tông vàng ngà có vân' },
  { id: 'crystal', name: 'Quân pha lê', hint: 'Trong suốt, sáng và nhẹ' }
] as const;

export const boardAssetOptions = themePresets.map(p => p.theme.boardAsset);
