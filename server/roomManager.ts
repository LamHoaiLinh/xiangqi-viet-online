...
export const defaultTheme: ThemeSettings = {
  theme: 'light', boardColor: '#f4d39a', lineColor: '#6d3518', riverColor: '#d9f2ff', redPieceColor: '#b51f1f', blackPieceColor: '#222222', highlightColor: '#48b87a', selectedColor: '#f2c94c', checkColor: '#ff4d4f', pieceStyle: 'asset'
};
